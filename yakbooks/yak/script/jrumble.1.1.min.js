	...
	$.fn.jrumble = function(options) {
		...
		return this.each(function() {
			...
			function rumbler(elem) {
				...
				var randX = Math.floor(Math.random() * (rangeX + 1)) - rangeX
						/ 2;
				var randY = Math.floor(Math.random() * (rangeY + 1)) - rangeY
						/ 2;
				var randRot = Math.floor(Math.random() * (rangeRot + 1))
						- rangeRot / 2;
			...
			if (opt.rumbleEvent === 'pagebeforeshow') {
				$obj.pagebeforeshow(function() {
					var rumblee = $(this);
					rumbleInterval = setInterval(function() {
						rumbler(rumblee);
					}, rumbleSpeed);
